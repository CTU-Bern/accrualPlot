...
In the second example we get site-specific predicions using a target vector (with the same date for all sites). Please note that the site-specifc estimates do not necessarily sum up to the overall because the are derived from separate models.
